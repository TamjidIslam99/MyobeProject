...
const Coursecontoutline = ({ addOutline }) => {
              ...
              <div className="checkbox-container">
                {clos.map((clo, index) => (
                  <div key={clo.id}>
                    ...
                    />
                    <label htmlFor={`cloCheck${index}`} className="pb-2">
                      CLO {index + 1}
                    </label>
                  </div>
                ))}
              ...
              <div className="checkbox-container">
                {knows.map((knowledge, index) => (
                  <div key={knowledge.id}>
                    ...
                    />
                    <label htmlFor={`knowledgeCheck${index}`} className="pb-2">
                      Knowledge {index + 1}
                    </label>
                  </div>
                ))}
              ...
              <div className="checkbox-container">
                {atts.map((att, index) => (
                  <div key={att.id}>
                    ...
                    />
                    <label htmlFor={`attCheck${index}`} className="pb-2">
                      Attitude {index + 1}
                    </label>
                  </div>
                ))}
              ...
              <div className="checkbox-container">
                {skills.map((skill, index) => (
                  <div key={skill.id}>
                    ...
                    />
                    <label htmlFor={`skillCheck${index}`} className="pb-2">
                      Skill {index + 1}
                    </label>
                  </div>
                ))}
