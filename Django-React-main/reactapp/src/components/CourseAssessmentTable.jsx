...
const CourseAssessmentTable = () => {
  ...
  const fetchCourseData = async () => {
     try {
       const response = await axios.get('http://127.0.0.1:8000/api/assess/');
  ...
  const handleSubmit = async (e) => {
    ...
    const requestData = {
     ...
     c_exper: c_exper,
     c_final: c_final,
     final:rem_fest+rem_assign+rem_exper+un_fest+un_assign+un_exper+apply_fest+apply_assign+apply_exper+analyze_fest+analyze_assign+analyze_exper+eva_fest+eva_assign+eva_exper+c_fest+c_assign+c_exper,
      isEditing: false
    };
    e.preventDefault();
       ...
       <table className='table table-bordered text-center table-hover border-dark'>
            ...
            <tbody>
                ...
                <tr >
                     ...
                     <td><input name="rem_fest" type="number"  value={rem_fest} onChange={(e) => setRem_fest(e.target.value)} className=' form-input form-control'/></td>
                     <td><input name="rem_assign" type="number" value={rem_assign} onChange={(e) => setRem_assign(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="rem_exper" type="number"  value={rem_exper} onChange={(e) => setRem_exper(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="rem_final" type="number" value={rem_final} onChange={(e) => setRem_final(e.target.value)} className='form-input form-control'/></td>
                </tr>
                <tr >
                     <th >Understand</th>
                
                     <td><input name="un_fest"  value={un_fest} onChange={(e) => setUn_fest(e.target.value)} type="number" className='form-input form-control'/></td>
                     <td><input name="un_assign" value={un_assign} onChange={(e) => setUn_assign(e.target.value)} type="number" className='form-input form-control'/></td>
                     <td><input name="un_exper" value={un_exper} onChange={(e) => setUn_exper(e.target.value)} type="number" className='form-input form-control'/></td>
                     <td><input name="un_final" value={un_final} onChange={(e) => setUn_final(e.target.value)} type="number" className='form-input form-control'/></td>
                </tr>
                <tr >
                     <th >Apply</th>
                
                     <td><input name="apply_fest" type="number" value={apply_fest} onChange={(e) => setApply_fest(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="apply_assign" type="number" value={apply_assign} onChange={(e) => setApply_assign(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="apply_exper" value={apply_exper} onChange={(e) => setApply_exper(e.target.value)} type="number" className='form-input form-control'/></td>
                     <td><input name="apply_final" value={apply_final} onChange={(e) => setApply_final(e.target.value)} type="number" className='form-input form-control'/></td>
                </tr>
                <tr >
                     <th >Analyze</th>
                
                     <td><input name="analyze_fest" type="number"  value={analyze_fest} onChange={(e) => setAnalyze_fest(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="analyze_assign" type="number" value={analyze_assign} onChange={(e) => setAnalyze_assign(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="analyze_exper" type="number" value={analyze_exper} onChange={(e) => setAnalyze_exper(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="analyze_final" type="number"  value={analyze_final} onChange={(e) => setAnalyze_final(e.target.value)} className='form-input form-control'/></td>
                </tr>
                <tr >
                     <th >Evaluate</th>
                
                     <td><input name="eva_fest" type="number" value={eva_fest} onChange={(e) => setEva_fest(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="eva_assign" type="number" value={eva_assign} onChange={(e) => setEva_assign(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="eva_exper" type="number"   value={eva_exper} onChange={(e) => setEva_exper(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="eva_final" type="number" value={eva_final} onChange={(e) => setEva_final(e.target.value)} className='form-input form-control'/></td>
                </tr>
                <tr >
                     <th >Creare</th>
                 
                     <td><input name="c_fest" type="number"  value={c_fest} onChange={(e) => setC_fest(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="c_assign" type="number" value={c_assign} onChange={(e) => setC_assign(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="c_exper" type="number" value={c_exper} onChange={(e) => setC_exper(e.target.value)} className='form-input form-control'/></td>
                     <td><input name="c_final" type="number" value={c_final} onChange={(e) => setC_final(e.target.value)} className='form-input form-control'/></td>
                </tr>
                <tr >
                     <th >Total</th>
